...
namespace ME.ECS {
    ...
    #endif
    public struct TimersStorage : IPlugin {
        ...
        public void Initialize(int key, ref MemoryAllocator allocator) {
            ...
            TimersStorage.key = key;
            this.values = new Dictionary<ulong, tfloat>(ref allocator, 1);
            this.indexes = new HashSet<uint>(ref allocator, 1);
